...
public class TaxonomyAnalysis {
	...
	public static String Analysis(String url) throws XPathExpressionException, IOException, SAXException, ParserConfigurationException {
		...
		// Create an AlchemyAPI object.
				...
				Document doc = alchemyObj.URLGetTaxonomy(url);
